...
var createAndSavePerson = function(done) {
  const person = new Person({
    name: "Spandau Simoni",
    age: 34,
    email: "danielli@serpi.it",
    favoriteFoods: ["pear", "lasagna", "pincho"]
  });
...
findPeopleByName({ name: "Danielli" }, function() {});
/** 6) Use `Model.findOne()` */
...
var findOneByFood = async function(food) {
  let result = await Person.FindOne({ favoriteFood: food });
  console.log(result);
};

findOneByFood("lasagna");
